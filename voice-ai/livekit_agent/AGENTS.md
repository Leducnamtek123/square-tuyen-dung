...
This project follows strict coding standards to ensure maintainability and scalability. All AI coding assistants **must** adhere to the [AI_RULES.md](file:///c:/Users/leduc/Documents/squareai/AI_RULES.md) file located at the project root.

Key principles from `AI_RULES.md`:
- **No Hardcoded Business Data**: Use external configurations, enums, or databases.
- **No Hardcoded UI Labels**: Always use i18n translation keys.
- **Enum-driven Identifiers**: Use enums for statuses and workflow stages.

Failure to follow these rules will result in unacceptable code quality.
