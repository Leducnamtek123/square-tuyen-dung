...
def test_should_enable_preemptive_min_chars() -> None:
    assert should_enable_preemptive("Xin chao", min_words=1, min_chars=20) is False


def test_should_enable_preemptive_min_words() -> None:
    assert should_enable_preemptive("Xin chao ban", min_words=4, min_chars=5) is False
