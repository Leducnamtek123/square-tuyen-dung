...
Uses FaceAlignment inside the container with GPU to detect the exact full-face bounding box
(forehead down to chin, eye to eye) for every frame of every action video, applying temporal
moving average smoothing (T=5) to guarantee rock-solid face tracking without jitter.
"""
...
print("\nAll action coordinates recomputed and saved successfully!")
