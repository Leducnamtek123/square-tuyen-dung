...
const PAGE_TITLES: Record<string, Record<SupportedLocale, string>> = {
  ...
  'employer.interview-scripts': { vi: 'Quản lý Kịch bản Phỏng vấn AI', en: 'AI Interview Scripts Management' },
  ...
  'employer.hrm.attendances':                   { vi: 'Tổng quan chấm công & quản lý chuyên cần', en: 'Attendance Overview & Time Tracking' },
  'employer.hrm.attendances.devices':           { vi: 'Quản lý thiết bị máy chấm công', en: 'Time Attendance Devices Management' },
  'employer.hrm.attendances.biometric-logs':    { vi: 'Nhật ký dữ liệu chấm công sinh trắc học', en: 'Biometric Attendance Logs' },
  'employer.hrm.attendances.requests':          { vi: 'Quản lý & phê duyệt đơn từ chấm công', en: 'Attendance Requests & Approvals' },
  'employer.hrm.attendances.shifts':            { vi: 'Quản lý danh mục ca làm việc', en: 'Work Shifts Management' },
  'employer.hrm.attendances.shift-assignments': { vi: 'Phân ca làm việc cho nhân viên', en: 'Shift Assignments & Scheduling' },
  'employer.hrm.attendances.timesheets':        { vi: 'Bảng chấm công chi tiết hàng ngày', en: 'Daily Detailed Timesheets' },
  'employer.hrm.attendances.monthly-summary':   { vi: 'Bảng tổng hợp công tháng nhân sự', en: 'Monthly Attendance Summary' },
  'employer.hrm.attendances.reports':           { vi: 'Báo cáo thống kê chuyên cần & đi muộn', en: 'Attendance & Punctuality Reports' },
  'employer.hrm.attendances.settings':          { vi: 'Cài đặt quy chế chấm công doanh nghiệp', en: 'Attendance Rules & Policy Settings' },
  ...
  'my-cvs':                   { vi: 'Quản lý danh sách CV của tôi', en: 'My Saved Resumes & CVs' },
  'practice':                 { vi: 'Luyện phỏng vấn AI thông minh AILA', en: 'AI Smart Interview Practice AILA' },
  'salary':                   { vi: 'Tra cứu mức lương chuẩn theo vị trí & ngành nghề', en: 'Market Salary Benchmark by Job & Industry' },
  'cv-builder':               { vi: 'Công cụ tạo CV xin việc chuyên nghiệp online', en: 'Online Professional CV Builder' },
  'cv-templates':             { vi: 'Danh sách mẫu CV xin việc đẹp chuẩn ATS', en: 'Professional ATS Resume Templates Directory' },
...
const PAGE_DESCRIPTIONS: Record<string, Record<SupportedLocale, string>> = {
  ...
  'practice': {
    vi: 'Luyện tập kỹ năng phỏng vấn cùng trợ lý AI AILA thông minh. Nhận phản hồi chuyên sâu và cải thiện sự tự tin trước kỳ phỏng vấn thực tế.',
    en: 'Practice interview skills with smart AI assistant AILA. Receive in-depth feedback and boost confidence before your real interviews.',
  },
  'salary': {
    vi: 'Dữ liệu khảo sát chuẩn hóa mức lương thị trường theo ngành nghề, vị trí và cấp bậc kinh nghiệm. Giúp bạn định giá năng lực chính xác.',
    en: 'Standardized market salary benchmark by industry, job role, and experience level. Accurately benchmark your market compensation.',
  },
  'cv-builder': {
    vi: 'Tạo CV chuyên nghiệp chuẩn ATS nhanh chóng và đẹp mắt với hàng chục mẫu thiết kế hiện đại, tùy biến linh hoạt cho mọi ngành nghề.',
    en: 'Build professional ATS-friendly resumes quickly with modern customizable templates tailored for all industries.',
  },
  'cv-templates': {
    vi: 'Tổng hợp các mẫu CV đẹp, hiện đại chuẩn ATS cho mọi ngành nghề: CNTT, Kinh doanh, Marketing, Thiết kế, Kế toán và Quản trị.',
    en: 'Collection of modern ATS-standard resume templates for all careers: IT, Sales, Marketing, Design, Accounting, and Management.',
  },
  'my-cvs': {
    vi: 'Quản lý, chỉnh sửa và tải xuống các mẫu CV cá nhân đã tạo trên hệ thống InfoHR một cách tiện lợi và bảo mật.',
    en: 'Manage, edit, and download your personalized CVs and resumes created on the InfoHR platform conveniently and securely.',
  },
  'employer.hrm.attendances': {
    vi: 'Bảng điều khiển chấm công, theo dõi chuyên cần nhân viên, giám sát ca làm việc và duyệt đơn từ chấm công tự động.',
    en: 'Attendance dashboard, employee time tracking, shift monitoring, and automated attendance request approvals.',
  },
};
