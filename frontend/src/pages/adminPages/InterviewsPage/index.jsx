...
const InterviewsPage = () => {
    ...
    const handleDelete = (id) => {
        if (window.confirm('Bạn có chắc chắn muốn xóa buổi phỏng vấn này?')) {
    ...
    return (
        <Box>
            <Typography variant="h4" sx={{ mb: 4, fontWeight: 'bold' }}>
                <VideocamOutlinedIcon sx={{ mr: 1, verticalAlign: 'middle' }} /> Quản lý Phỏng vấn trực tuyến
            </Typography>

            <Card>
                <CardHeader title="Danh sách các buổi phỏng vấn" />
                <CardContent>
                    <InterviewTable
