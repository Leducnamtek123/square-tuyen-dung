    ...
    return (
        <Box>
            <Box sx={{ mb: 3, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                <Box>
                    ...
                    <Breadcrumbs aria-label="breadcrumb">
                        ...
                        <Typography color="text.primary">Thông báo việc làm</Typography>
                    </Breadcrumbs>
                </Box>
                <Button
                    variant="contained"
            ...
            <Dialog open={openDialog} onClose={handleCloseDialog} fullWidth maxWidth="sm">
                <DialogTitle>
                    {dialogMode === 'add' ? 'Tạo thông báo mới' : 'Chỉnh sửa thông báo'}
                </DialogTitle>
                <DialogContent>
                    <Box sx={{ pt: 1, display: 'flex', flexDirection: 'column', gap: 2 }}>
                        ...
                        />
                        <TextField
                            label="ID người nhận (Để trống nếu gửi hệ thống)"
                            fullWidth
                            name="user"
                            value={formData.user}
                            onChange={handleInputChange}
            ...
            <Dialog open={openDeleteDialog} onClose={() => setOpenDeleteDialog(false)}>
                ...
                <DialogContent>
                    <Typography>
                        Bạn có chắc chắn muốn xóa thông báo <strong>{currentNotification?.title}</strong>?
