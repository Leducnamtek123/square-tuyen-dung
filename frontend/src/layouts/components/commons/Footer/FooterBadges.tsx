...
export const GooglePlayBadge = ({ height = 38 }: { height?: number }) => {
  ...
  return (
    <Link
      ...
      aria-label={t('footer.downloadGooglePlay', 'Tải ứng dụng trên Google Play')}
      sx={{
        display: 'inline-flex',
        alignItems: 'center',
        gap: 1,
...
export const AppStoreBadge = ({ height = 38 }: { height?: number }) => {
  ...
  return (
    <Link
      ...
      target="_blank"
      rel="noopener noreferrer"
      aria-label={t('footer.downloadAppStore', 'Tải ứng dụng trên App Store')}
      sx={{
        display: 'inline-flex',
        alignItems: 'center',
        gap: 1,
...
export const MinistryOfIndustryBadge = () => {
  ...
  return (
    <Link
      ...
      target="_blank"
      rel="noopener noreferrer"
      aria-label={t('footer.ministryRegistered', 'Đã Đăng Ký Bộ Công Thương')}
      sx={{
        display: 'inline-flex',
        alignItems: 'center',
        textDecoration: 'none',
