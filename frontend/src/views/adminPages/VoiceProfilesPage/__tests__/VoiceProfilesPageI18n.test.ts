...
const fixedKeys = [
  ...
  'pages.voiceProfiles.searchPlaceholder',
  'pages.voiceProfiles.filter.title',
  'pages.voiceProfiles.filter.description',
  'pages.voiceProfiles.filter.reset',
  'pages.voiceProfiles.filter.advanced',
  'pages.voiceProfiles.filter.status',
  'pages.voiceProfiles.filter.type',
  'pages.voiceProfiles.filter.all',
  ...
  'pages.voiceProfiles.actions.prepareVoice',
  ...
  'pages.voiceProfiles.messages.preparationSummary',
  'pages.voiceProfiles.messages.readyForReuse',
  'pages.voiceProfiles.messages.needsPrepare',
