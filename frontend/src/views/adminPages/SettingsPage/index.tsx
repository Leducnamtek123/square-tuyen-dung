...
import {
  Box, Typography, Breadcrumbs, Link, Paper, Grid2 as Grid,
...
const SettingsPage = () => {
  ...
  return (
    <Box>
      <Box sx={{ mb: 3 }}>
        <Typography variant="h5" sx={{ fontWeight: 700, mb: 1 }}>{t('pages.settings.title')}</Typography>
        <Breadcrumbs>
          <Link underline="hover" color="inherit" href="/admin">{t('pages.settings.breadcrumbAdmin')}</Link>
      ...
      <Grid container spacing={3}>
        <Grid size={{ xs: 12, md: 8 }}>
          <Stack spacing={3}>
            ...
            <Card elevation={0} sx={{ borderRadius: '16px', border: '1px solid', borderColor: 'divider' }}>
              <CardContent sx={{ p: 3 }}>
                <Typography variant="h6" sx={{ mb: 2, fontWeight: 700 }}>{t('pages.settings.generalTitle')}</Typography>
                <Divider sx={{ mb: 3 }} />
                ...
                <Stack spacing={3}>
                  <FormControlLabel
                    ...
                    label={
                      <Box sx={{ ml: 1 }}>
                        <Typography variant="subtitle2" fontWeight={700}>{t('pages.settings.maintenanceMode.label')}</Typography>
                        <Typography variant="caption" color="text.secondary">{t('pages.settings.maintenanceMode.desc')}</Typography>
                      </Box>
                    }
                  />
                  ...
                  <FormControlLabel
                    control={
                      <Switch
                        ...
                        onChange={handleToggleChange('autoApproveJobs')}
                      />
                    }
                    label={
                      <Box sx={{ ml: 1 }}>
                        <Typography variant="subtitle2" fontWeight={700}>{t('pages.settings.autoApproveJobs.label')}</Typography>
                        <Typography variant="caption" color="text.secondary">{t('pages.settings.autoApproveJobs.desc')}</Typography>
                      </Box>
                    }
                  />
                  ...
                  <FormControlLabel
                    ...
                    label={
                      <Box sx={{ ml: 1 }}>
                        <Typography variant="subtitle2" fontWeight={700}>{t('pages.settings.emailNotifications.label')}</Typography>
                        <Typography variant="caption" color="text.secondary">{t('pages.settings.emailNotifications.desc')}</Typography>
                      </Box>
                    }
                  />
                </Stack>
            ...
            <Card elevation={0} sx={{ borderRadius: '16px', border: '1px solid', borderColor: 'divider' }}>
              <CardContent sx={{ p: 3 }}>
                <Typography variant="h6" sx={{ mb: 2, fontWeight: 700 }}>{t('pages.settings.apiTitle')}</Typography>
                <Divider sx={{ mb: 3 }} />
        ...
        <Grid size={{ xs: 12, md: 4 }}>
          <Paper sx={{ p: 3, borderRadius: '16px', position: 'sticky', top: 24, border: '1px solid', borderColor: 'divider' }} elevation={0}>
            <Typography variant="subtitle1" sx={{ fontWeight: 700, mb: 2 }}>{t('pages.settings.summary')}</Typography>
