...
export const InterviewPreparationModal: React.FC<InterviewPreparationModalProps> = ({
  ...
  const stepItems = [
    ...
    {
      key: 'script',
      title: 'Phân tích hồ sơ CV và kịch bản phỏng vấn',
      icon: <DescriptionOutlinedIcon sx={{ fontSize: 20, color: '#2563eb' }} />,
      status: steps.script,
      pendingText: 'Đang chờ...',
      processingText: 'Đang nạp hồ sơ và phân tích...',
      completedText: 'Đã hoàn tất phân tích',
      errorText: 'Lỗi tải kịch bản',
    },
    {
      key: 'agent',
      title: 'Trợ lý AI AILA sẵn sàng trao đổi',
      icon: <AilaLogo size={18} variant="mark" />,
      status: steps.agent,
      pendingText: 'Đang chờ...',
      processingText: 'Đang làm nóng giọng nói AI và kết nối...',
      completedText: 'Đã sẵn sàng phỏng vấn',
      errorText: 'Lỗi kết nối Trợ lý AI',
    },
  ];
