...
const fixedKeys = [
  ...
  'agentAssistant.attachments.addImage',
  'agentAssistant.attachments.remove',
  'agentAssistant.attachments.threadTitle',
  'agentAssistant.attachments.limit',
  'agentAssistant.attachments.unsupported',
  'agentAssistant.attachments.tooLarge',
  'agentAssistant.attachments.readError',
