...
interface CandidateStepperProps {
  activeStep: number;
  steps: string[];
}

export default function CandidateStepper({ activeStep, steps }: CandidateStepperProps) {
      ...
      <Box sx={{ mb: 3.5, width: '100%' }}>
        <Stack direction="row" justifyContent="space-between" alignItems="center" mb={1}>
          <Typography variant="caption" sx={{ fontWeight: 700, color: '#2563EB', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
            {t('onboarding.stepCounter', { current: activeStep + 1, total: totalSteps })}
          </Typography>
