...
export const LEGAL_DOCUMENTS: Record<string, LegalDocument> = {
  'tuan-thu-va-su-dong-y-cua-khach-hang': {
    ...
    title: 'InfoHR tuân thủ và xác nhận sự đồng ý của người dùng về chính sách dữ liệu cá nhân',
    shortTitle: 'Tuân thủ & Sự đồng ý',
    subtitle: 'Cam kết bảo vệ dữ liệu cá nhân theo Nghị định 13/2023/NĐ-CP của Chính phủ',
    category: 'legal',
    targetAudience: 'all',
  ...
  'thoa-thuan-su-dung': {
    ...
    subtitle: 'Quy định và điều kiện sử dụng dịch vụ trên nền tảng InfoHR.vn',
    category: 'legal',
    targetAudience: 'all',
    lastUpdated: '18/11/2024',
  ...
  'quy-dinh-bao-mat': {
    ...
    subtitle: 'Tiêu chuẩn bảo mật dữ liệu và an toàn thông tin tại InfoHR',
    category: 'policy',
    targetAudience: 'all',
    lastUpdated: '18/11/2024',
    effectiveDate: '01/01/2024',
  ...
  'chinh-sach-bao-hanh': {
    ...
    subtitle: 'Quy định bảo hành quyền lợi dành cho Nhà tuyển dụng sử dụng dịch vụ InfoHR',
    category: 'policy',
  ...
  'so-do-trang-web': {
    ...
    subtitle: 'Tổng hợp toàn bộ liên kết, danh mục ngành nghề và dịch vụ trên hệ thống',
    category: 'sitemap',
    targetAudience: 'all',
    lastUpdated: '18/11/2024',
    effectiveDate: '01/01/2024',
  ...
  'quy-dinh-dang-tin': {
    ...
    subtitle: 'Hướng dẫn đăng tin minh bạch, hiệu quả và đúng quy định pháp luật',
    category: 'policy',
    targetAudience: 'employer',
    lastUpdated: '18/11/2024',
    effectiveDate: '01/01/2024',
