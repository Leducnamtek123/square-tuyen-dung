...
export default function AdminCommandPalette({ open, onClose }: AdminCommandPaletteProps) {
  ...
  const COMMAND_ITEMS: NavCommand[] = useMemo(
    () => [
      ...
      { id: 'interviews', title: t('admin:sidebar.interviewSchedule', 'Lịch phỏng vấn trực tuyến'), category: t('admin:commandPalette.recruitment', 'Tuyển dụng'), route: ROUTES.ADMIN.INTERVIEWS, icon: WorkOutlineOutlinedIcon, keywords: ['interviews', 'phong van', 'lich hen'] },
      ...
      { id: 'resumes', title: t('admin:sidebar.resumeManagement', 'Quản lý CV & Hồ sơ ứng viên'), category: t('admin:commandPalette.profiles', 'Hồ sơ'), route: ROUTES.ADMIN.RESUMES, icon: ArticleOutlinedIcon, keywords: ['resumes', 'cv', 'ho so', 'ung vien'] },
      ...
      { id: 'interview-preview', title: t('admin:sidebar.interviewPreview', 'Xem trước phòng phỏng vấn AI'), category: t('admin:commandPalette.aiInterview', 'Phỏng vấn AI'), route: ROUTES.ADMIN.INTERVIEW_PREVIEW, icon: SmartToyOutlinedIcon, keywords: ['interview', 'preview', 'xem truoc', 'phong van'] },
    ],
    [t]
  );
