...
const nextConfig = {
  ...
  async rewrites() {
    ...
    return [
      ...
      { source: '/ung-vien/cv-cua-toi', destination: '/my-cvs' },
      { source: '/ung-vien/my-cvs', destination: '/my-cvs' },
      { source: '/viec-lam-cua-toi', destination: '/my-jobs' },
      { source: '/ung-vien/viec-lam-cua-toi', destination: '/my-jobs' },
      { source: '/ung-vien/my-jobs', destination: '/my-jobs' },
      { source: '/cong-ty-cua-toi', destination: '/my-company' },
      { source: '/ung-vien/cong-ty-cua-toi', destination: '/my-company' },
      { source: '/ung-vien/my-company', destination: '/my-company' },
      { source: '/phong-van-cua-toi', destination: '/my-interviews' },
      { source: '/ung-vien/phong-van-cua-toi', destination: '/my-interviews' },
      { source: '/ung-vien/my-interviews', destination: '/my-interviews' },
      { source: '/luyen-phong-van', destination: '/practice' },
      { source: '/phong-van-thu', destination: '/practice' },
      { source: '/ung-vien/phong-van-thu', destination: '/practice' },
      { source: '/ung-vien/luyen-phong-van', destination: '/practice' },
      { source: '/ung-vien/practice', destination: '/practice' },
      { source: '/candidate/practice', destination: '/practice' },
      { source: '/tra-cuu-luong', destination: '/salary' },
      { source: '/ung-vien/tra-cuu-luong', destination: '/salary' },
      { source: '/ung-vien/salary', destination: '/salary' },
      { source: '/candidate/salary', destination: '/salary' },
      { source: '/thong-bao', destination: '/notifications' },
      { source: '/ung-vien/thong-bao', destination: '/notifications' },
      { source: '/ung-vien/notifications', destination: '/notifications' },
      { source: '/tai-khoan', destination: '/account' },
      { source: '/ung-vien/tai-khoan', destination: '/account' },
      { source: '/ung-vien/account', destination: '/account' },
      { source: '/ung-vien/bang-dieu-khien', destination: '/dashboard' },
      { source: '/ung-vien/dashboard', destination: '/dashboard' },
      { source: '/ung-vien/ho-so', destination: '/profile' },
      { source: '/ung-vien/profile', destination: '/profile' },
      { source: '/ung-vien/ho-so-tung-buoc/:slug', destination: '/online-profile/:slug' },
      { source: '/ung-vien/ho-so-dinh-kem/:slug', destination: '/attached-profile/:slug' },
      { source: '/ung-vien/tao-cv', destination: '/cv-builder' },
      { source: '/ung-vien/cv-builder', destination: '/cv-builder' },
      { source: '/ket-noi-voi-nha-tuyen-dung', destination: '/chat' },
      { source: '/ung-vien/ket-noi-voi-nha-tuyen-dung', destination: '/chat' },
      { source: '/ung-vien/chat', destination: '/chat' },
      ...
      { source: '/nha-tuyen-dung/tin-tuyen-dung/tao-moi', destination: '/employer/job-posts/create' },
      { source: '/nha-tuyen-dung/tin-tuyen-dung/:id/chinh-sua', destination: '/employer/job-posts/:id/edit' },
      { source: '/nha-tuyen-dung/tin-tuyen-dung/:id/edit', destination: '/employer/job-posts/:id/edit' },
      ...
      { source: '/nha-tuyen-dung/resumes', destination: '/employer/candidates' },
      { source: '/nha-tuyen-dung/resumes/:path*', destination: '/employer/candidates/:path*' },
      { source: '/employer/resumes', destination: '/employer/candidates' },
      { source: '/employer/resumes/:path*', destination: '/employer/candidates/:path*' },
      ...
      { source: '/nha-tuyen-dung/hrm/attendances/reports', destination: '/employer/hrm/attendances/reports' },
      { source: '/nha-tuyen-dung/hrm/attendances/settings', destination: '/employer/hrm/attendances/settings' },
      ...
      { source: '/nha-tuyen-dung/hrm/cham-cong/bao-cao', destination: '/employer/hrm/attendances/reports' },
      { source: '/nha-tuyen-dung/hrm/cham-cong/thiet-bi', destination: '/employer/hrm/attendances/devices' },
      { source: '/nha-tuyen-dung/hrm/cham-cong/thiet-lap', destination: '/employer/hrm/attendances/settings' },
      ...
      { source: '/nha-tuyen-dung/hrm/thiet-bi-cham-cong', destination: '/employer/hrm/attendances/devices' },
      { source: '/nha-tuyen-dung/hrm/bao-cao-cham-cong', destination: '/employer/hrm/attendances/reports' },
      { source: '/nha-tuyen-dung/hrm/thiet-lap-cham-cong', destination: '/employer/hrm/attendances/settings' },
