...
const nextConfig = {
  ...
  async rewrites() {
    ...
    return [
      ...
      { source: '/nha-tuyen-dung/hrm/attendances', destination: '/employer/hrm/attendances' },
      { source: '/nha-tuyen-dung/hrm/attendances/:path*', destination: '/employer/hrm/attendances/:path*' },
      { source: '/nha-tuyen-dung/hrm/cham-cong', destination: '/employer/hrm/attendances' },
      { source: '/nha-tuyen-dung/hrm/cham-cong/chi-tiet', destination: '/employer/hrm/attendances/timesheets' },
      { source: '/nha-tuyen-dung/hrm/cham-cong/tong-hop', destination: '/employer/hrm/attendances/monthly-summary' },
      { source: '/nha-tuyen-dung/hrm/cham-cong/:path*', destination: '/employer/hrm/attendances/:path*' },
      { source: '/nha-tuyen-dung/hrm/ca-lam-viec', destination: '/employer/hrm/attendances/shifts' },
      { source: '/nha-tuyen-dung/hrm/ca-lam-viec/:path*', destination: '/employer/hrm/attendances/shifts/:path*' },
      { source: '/nha-tuyen-dung/hrm/phan-ca', destination: '/employer/hrm/attendances/shift-assignments' },
      { source: '/nha-tuyen-dung/hrm/phan-ca/:path*', destination: '/employer/hrm/attendances/shift-assignments/:path*' },
      { source: '/nha-tuyen-dung/hrm/quan-ly-don', destination: '/employer/hrm/attendances/requests' },
      { source: '/nha-tuyen-dung/hrm/quan-ly-don/:path*', destination: '/employer/hrm/attendances/requests/:path*' },
      { source: '/nha-tuyen-dung/hrm/may-cham-cong', destination: '/employer/hrm/attendances/biometric-logs' },
      { source: '/nha-tuyen-dung/hrm/may-cham-cong/:path*', destination: '/employer/hrm/attendances/biometric-logs/:path*' },
      { source: '/nha-tuyen-dung/hrm/payroll', destination: '/employer/hrm/payroll' },
      { source: '/nha-tuyen-dung/hrm/payroll/:path*', destination: '/employer/hrm/payroll/:path*' },
      { source: '/nha-tuyen-dung/hrm/bang-luong', destination: '/employer/hrm/payroll' },
      { source: '/nha-tuyen-dung/hrm/bang-luong/:path*', destination: '/employer/hrm/payroll/:path*' },
      ...
      { source: '/quan-tri/hrm/attendances', destination: '/admin/hrm/attendances' },
      { source: '/quan-tri/hrm/attendances/:path*', destination: '/admin/hrm/attendances/:path*' },
      { source: '/quan-tri/hrm/cham-cong', destination: '/admin/hrm/attendances' },
      { source: '/quan-tri/hrm/cham-cong/:path*', destination: '/admin/hrm/attendances/:path*' },
      { source: '/quan-tri/hrm/payroll', destination: '/admin/hrm/payroll' },
      { source: '/quan-tri/hrm/payroll/:path*', destination: '/admin/hrm/payroll/:path*' },
      { source: '/quan-tri/hrm/bang-luong', destination: '/admin/hrm/payroll' },
      { source: '/quan-tri/hrm/bang-luong/:path*', destination: '/admin/hrm/payroll/:path*' },
