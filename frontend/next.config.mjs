...
const nextConfig = {
  ...
  async rewrites() {
    return [
      ...
      { source: '/quan-tri', destination: '/admin' },
      ...
      { source: '/quan-tri/login', destination: '/admin/login' },
      { source: '/quan-tri/forgot-password', destination: '/admin/forgot-password' },
      { source: '/quan-tri/reset-password/:path*', destination: '/admin/reset-password/:path*' },
