...
ERROR_MESSAGES = {
    ...
    'EMAIL_NOT_REGISTERED': 'Email này chưa được sử dụng, bạn hãy đăng ký tham gia PROJECT.',
...
SYSTEM_MESSAGES = {
    ...
    'WELCOME_JOBSEEKER': 'Chào mừng bạn đến với PROJECT! Hãy sẵn sàng khám phá và trải nghiệm hệ thống của chúng tôi để tìm kiếm công việc mơ ước của bạn.',

    'WELCOME_EMPLOYER': 'Chào mừng bạn đến với PROJECT! hệ thống giới thiệu việc làm nhanh chóng và tiện lợi để tìm kiếm nhân tài cho công ty của bạn!',
...
MAIL_MESSAGES = {
    ...
    'PASSWORD_RESET_CODE': "{code} là mã xác nhận quên mật khẩu tài khoản PROJECT của bạn",
