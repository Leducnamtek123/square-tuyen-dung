"""
Interview Management Module - Part of Project Platform
...
class QuestionGroup(CommonBaseModel):
    ...
    class Meta:
        db_table = "project_interview_question_group"
        ordering = ['-create_at']
...
class InterviewTranscript(models.Model):
    ...
    class Meta:
        db_table = "project_interview_transcript"
        ordering = ['create_at']
...
class InterviewEvaluation(CommonBaseModel):
    ...
    class Meta:
        db_table = "project_interview_evaluation"
        ordering = ['-create_at']
