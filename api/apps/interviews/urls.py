...
web_router.register('scripts', views.InterviewScriptViewSet, basename='interview-scripts')
...
scripts_router = DefaultRouter()
scripts_router.register('', views.InterviewScriptViewSet, basename='interview-scripts-direct')
...
urlpatterns = [
    ...
    path('scripts/', include(scripts_router.urls)),
