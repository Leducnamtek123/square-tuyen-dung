...
BANNERS_DATA = [
    ...
    {
        "id": 4,
        "description": "Nội thất Square tuyển designer hiểu thẩm mỹ và triển khai thực tế",
    ...
    {
        "id": 6,
        "description": "Trải nghiệm trợ lý phỏng vấn AI thông minh & đánh giá năng lực 24/7",
        "button_text": "Trải nghiệm AI",
        "button_link": "/cv-templates",
        "is_show_button": True,
        "platform": var_sys.Platform.WEB,
        "type": var_sys.BannerType.HOME,
        "description_location": var_sys.DescriptionLocation.BOTTOM_RIGHT,
        "is_active": True,
        "web_img": "home_ai_interview_web.jpg",
        "mobile_img": "home_ai_interview_mobile.jpg",
    },
    {
        "id": 7,
        "description": "Hàng trăm vị trí Kỹ sư MEP, HVAC, Điện nhẹ & Năng lượng công trình",
        "button_text": "Khám phá việc MEP",
        "button_link": "/viec-lam",
        "is_show_button": True,
        "platform": var_sys.Platform.WEB,
        "type": var_sys.BannerType.HOME,
        "description_location": var_sys.DescriptionLocation.TOP_LEFT,
        "is_active": True,
        "web_img": "home_mep_engineering_web.jpg",
        "mobile_img": "home_mep_engineering_mobile.jpg",
    },
    {
        "id": 8,
        "description": "Kết nối Giám đốc Ban QLDA, Chuyên viên Dự toán QS & Đấu thầu cao cấp",
        "button_text": "Xem vị trí Hot",
        "button_link": "/viec-lam",
        "is_show_button": True,
        "platform": var_sys.Platform.WEB,
        "type": var_sys.BannerType.HOME,
        "description_location": var_sys.DescriptionLocation.BOTTOM_LEFT,
        "is_active": True,
        "web_img": "home_project_management_web.jpg",
        "mobile_img": "home_project_management_mobile.jpg",
    },

    # ── MAIN JOB RIGHT BANNERS (Job Listing & Sidebar Ads) ────────────
    {
        "id": 9,
        "description": "Đăng tin tuyển dụng dự án nhanh - Tiếp cận 50.000+ ứng viên chất lượng",
    ...
    {
        "id": 10,
        "description": "Tạo CV chuyên nghiệp chuẩn ngành Xây dựng, Kiến trúc & BĐS miễn phí",
        "button_text": "Tạo CV ngay",
        "button_link": "/tao-cv",
        "is_show_button": True,
        "platform": var_sys.Platform.WEB,
        "type": var_sys.BannerType.MAIN_JOB_RIGHT,
        "description_location": var_sys.DescriptionLocation.BOTTOM_LEFT,
        "is_active": True,
        "web_img": "right_cv_builder_web.jpg",
        "mobile_img": "right_cv_builder_mobile.jpg",
    },
    {
        "id": 11,
        "description": "Trợ lý AI sàng lọc hồ sơ tự động - Tiết kiệm 80% thời gian tuyển dụng",
        "button_text": "Khám phá AI",
        "button_link": "/employer/agent-assistants",
        "is_show_button": True,
        "platform": var_sys.Platform.WEB,
        "type": var_sys.BannerType.MAIN_JOB_RIGHT,
        "description_location": var_sys.DescriptionLocation.BOTTOM_LEFT,
        "is_active": True,
        "web_img": "right_ai_assistant_web.jpg",
        "mobile_img": "right_ai_assistant_mobile.jpg",
    },
    {
        "id": 12,
        "description": "Hệ thống Quản trị Nhân sự HRM: Chấm công, Hợp đồng & Lương tự động",
        "button_text": "Trải nghiệm HRM",
        "button_link": "/employer/hrm/dashboard",
        "is_show_button": True,
        "platform": var_sys.Platform.WEB,
        "type": var_sys.BannerType.MAIN_JOB_RIGHT,
        "description_location": var_sys.DescriptionLocation.BOTTOM_LEFT,
        "is_active": True,
        "web_img": "right_hrm_suite_web.jpg",
        "mobile_img": "right_hrm_suite_mobile.jpg",
    },
    {
        "id": 13,
        "description": "Xác thực Doanh nghiệp Tích Xanh - Tăng 300% tương tác từ ứng viên VIP",
        "button_text": "Xác thực ngay",
        "button_link": "/employer/verification",
        "is_show_button": True,
        "platform": var_sys.Platform.WEB,
        "type": var_sys.BannerType.MAIN_JOB_RIGHT,
        "description_location": var_sys.DescriptionLocation.BOTTOM_LEFT,
        "is_active": True,
        "web_img": "right_employer_verify_web.jpg",
        "mobile_img": "right_employer_verify_mobile.jpg",
    },
]
