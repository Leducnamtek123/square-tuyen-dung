...
MAX_IMAGES_PER_COMPANY = 15

MAX_CERTIFICATES_PER_RESUME = 10

MAX_EXPERIENCES_PER_RESUME = 10

MAX_EDUCATIONS_PER_RESUME = 10

MAX_LANGUAGES_PER_RESUME = 10

MAX_ADVANCED_SKILLS_PER_RESUME = 15
